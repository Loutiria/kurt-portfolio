    ...
    <main className="min-h-screen overflow-hidden bg-[#070b12] text-white selection:bg-cyan-300 selection:text-slate-950">
          ...
          <div className="hidden items-center gap-7 md:flex">
            {[
              ...
              <button
                ...
                className="text-sm font-medium capitalize text-slate-300 transition hover:text-cyan-300"
              >
                {item}
              </button>
            ))}
      ...
      >
        ...
        >
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-500/10 px-4 py-2 text-sm text-cyan-100">
            <CheckCircle size={16} /> Available for VA and operations support
            roles
          </div>
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-cyan-300 px-6 py-4 font-semibold text-slate-950 transition hover:bg-cyan-200 hover:shadow-lg hover:shadow-cyan-300/20"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/15 px-6 py-4 font-semibold transition hover:border-cyan-300/50 hover:bg-white/10"
            >
          ...
          <Card className="relative overflow-hidden p-8">
            ...
            <div className="mt-8 space-y-4 text-slate-300">
              <p className="flex items-center gap-3">
                <MapPin size={18} className="text-cyan-300" /> Iloilo City,
                Philippines
              </p>
              <p className="flex items-center gap-3">
              ...
              <p className="flex items-center gap-3">
                <Phone size={18} className="text-cyan-300" /> Phone available
                upon request
              </p>
            </div>
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-24">
        <SectionHeader
          ...
          description="This section is designed for recruiters and clients who need to quickly understand the kinds of tasks I can support."
        />
      ...
      <section id="workflow" className="mx-auto max-w-7xl px-6 py-24">
        <SectionHeader
          ...
          description="This shows how I approach tasks so outputs stay organized, traceable, and easier to review."
        />
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="text-3xl font-bold">
                Currently available for remote and part-time support
                opportunities.
              </h2>
              <p className="mt-4 max-w-3xl leading-7 text-slate-300">
                Open to Virtual Assistant roles, administrative support,
                documentation and operations support, project coordination,
                creative assistance, and student-friendly remote work
                arrangements.
              </p>
            </div>
      ...
      <section id="languages" className="mx-auto max-w-7xl px-6 py-24">
        <SectionHeader
          label="Languages"
          title="Communication range for local and remote support work."
        />
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                I’m open to remote administrative, coordination,
                documentation, creative, and digital support opportunities.
              </p>
            </div>
          ...
          <Card>
            ...
            <div className="mt-7 space-y-5 text-slate-300">
              ...
              <p className="flex items-center gap-4">
                <Phone className="text-cyan-300" /> Phone available upon
                request
              </p>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 text-sm text-slate-400">
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                <Clock className="mb-3 text-cyan-300" /> Responsive within
                available hours
              </div>

              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                <Target className="mb-3 text-cyan-300" /> Open to remote
                support roles
              </div>
            </div>
          </Card>
          ...
          <Card>
            ...
            >
              ...
              <p className="text-xs leading-6 text-slate-500">
                ...
                limits, and a hidden anti-spam honeypot. Deploy on Netlify to
      ...
      <footer className="border-t border-white/10 px-6 py-8 text-center text-sm text-slate-500">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 md:flex-row">
          <p>© 2026 Kurt Panolino — Resume Portfolio Website</p>
          ...
          <div className="flex gap-4">
            ...
            <a href="/Kurt-Panolino-Resume.pdf" className="hover:text-cyan-300">
              Resume PDF
            </a>
          </div>
        </div>
