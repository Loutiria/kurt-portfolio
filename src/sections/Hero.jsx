...
function AvailabilityBadge() {
  return (
    <motion.div
      animate={{
        boxShadow: [
          "0 0 0px rgba(103,232,249,0.15)",
          "0 0 28px rgba(103,232,249,0.35)",
          "0 0 0px rgba(103,232,249,0.15)",
        ],
      }}
      transition={{ repeat: Infinity, duration: 2.4 }}
      className="inline-flex items-center gap-2 rounded-full border border-cyan-300/30 bg-cyan-300/10 px-4 py-2 text-sm text-cyan-100"
    >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="mt-6 max-w-4xl text-5xl font-black leading-[0.98] tracking-[-0.06em] md:text-7xl">
